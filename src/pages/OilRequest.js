...
const OilRequest = ({ navigation }) => {
    const [name, setName] = useState('Ali Tamer');
    const [surname, setSurname] = useState('Kara');
    const [email, setEmail] = useState('');
    const [phone, setPhone] = useState('5530539952');
    const [labelName, setLabelName] = useState('Gülbahar Meyhane');
        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={styles.formItem}>
                    <Text style={styles.no}>Müşteri No:</Text>
                ...
                <View style={styles.formItem}>
                <Text style={styles.label}>Ortalama Biriktirlen Yağ</Text>
                <TextInput
                ...
                <View style={styles.buttonContainer}>
                    <InfoButton onPress={save}>Talep Oluştur</InfoButton>
                </View>
            </View>
        </ScrollView>
    );
